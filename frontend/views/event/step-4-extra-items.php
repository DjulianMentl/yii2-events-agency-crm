        ...
        <ul class="extra-items-list">
            <?php foreach ($model->extraItemForms as $extraItemForm) : ?>
                <li>
                    <div class="inner">
                        <div class="img">
                            <?= Html::img($extraItemForm->wizardListImageUrl) ?>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="presentation-wrapper">
                            <div class="img">
                                <?= Html::img($extraItemForm->desktopWizardModalImageUrl, ['class' => 'desktop-image']) ?>
                                <?= Html::img($extraItemForm->mobilepWizardModalImageUrl, ['class' => 'mobile-image']) ?>
                            </div>
                                ...
                                <div class="description-container">
                                    <div class="header">
                                        ...
                                        <div class="controls">
                                            ...
                                            <?php $plusBtn = Html::a('', '#', ['class' => "control-button plus"]) ?>
                                            <?php $minusBtn = Html::a('', '#', ['class' => "control-button minus"]) ?>
